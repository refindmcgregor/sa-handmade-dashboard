...
const productLinks = (p) => {
  ...
  return [
    ...
    { label: "Facebook", url: `https://www.facebook.com/search/posts/?q=${search}` },
  ];
};
...
const categoryLinks = {
  "Sewing": [
    ...
    { label: "Sewing on Facebook", url: "https://www.facebook.com/groups/sewingsouthafrica/" },
  ...
  "Crochet": [
    ...
    { label: "Crochet on Facebook", url: "https://www.facebook.com/groups/crochetsa/" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Knit": [
    ...
    { label: "Knitting on Facebook", url: "https://www.facebook.com/groups/knittersofsa/" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Stickers & Prints": [
    ...
    { label: "Stickers on Facebook", url: "https://www.facebook.com/search/groups/?q=stickers%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Plants": [
    ...
    { label: "Plants on Facebook", url: "https://www.facebook.com/groups/plantsofsouthafrica/" },
  ],
  "Candles": [
    ...
    { label: "Candles on Facebook", url: "https://www.facebook.com/search/groups/?q=candles%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Soap & Bath": [
    ...
    { label: "Soap on Facebook", url: "https://www.facebook.com/search/groups/?q=handmade%20soap%20south%20africa" },
  ...
  "Beadwork & Jewelry": [
    ...
    { label: "Beadwork on Facebook", url: "https://www.facebook.com/search/groups/?q=zulu%20beadwork" },
  ...
  "Woven & Basketry": [
    ...
    { label: "Baskets on Facebook", url: "https://www.facebook.com/search/groups/?q=south%20african%20baskets" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Ceramics": [
    ...
    { label: "Ceramics on Facebook", url: "https://www.facebook.com/groups/sapotters/" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Leather": [
    ...
    { label: "Leather on Facebook", url: "https://www.facebook.com/search/groups/?q=leather%20craft%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Wood & Carving": [
    ...
    { label: "Woodwork on Facebook", url: "https://www.facebook.com/search/groups/?q=woodworking%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Wirework": [
    ...
    { label: "Wire art on Facebook", url: "https://www.facebook.com/search/groups/?q=wire%20art%20south%20africa" },
  ...
  "Tea & Herbal": [
    ...
    { label: "Tea on Facebook", url: "https://www.facebook.com/search/groups/?q=rooibos%20tea" },
  ...
  "Coffee": [
    ...
    { label: "Coffee on Facebook", url: "https://www.facebook.com/search/groups/?q=south%20africa%20coffee%20roasters" },
  ],
};
