...
const productLinks = (p) => {
  ...
  return [
    { label: "Instagram", url: `https://www.instagram.com/explore/search/keyword/?q=%23${tag}sa` },
    { label: "TikTok", url: `https://www.tiktok.com/search?q=${encodeURIComponent(p.name + " South Africa")}` },
    { label: "Facebook", url: `https://www.google.com/search?q=site:facebook.com+${search}` },
  ];
};
...
const categoryLinks = {
  "Sewing": [
    { label: "#sewingSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23sewingsa" },
    { label: "#shweshwe on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23shweshwe" },
    { label: "Sewing on Facebook", url: "https://www.google.com/search?q=site:facebook.com+sewingsouthafrica+south+africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Crochet": [
    { label: "#crochetSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23crochetsa" },
    { label: "#crochetsouthafrica on TikTok", url: "https://www.tiktok.com/tag/crochetsouthafrica" },
    { label: "Crochet on Facebook", url: "https://www.google.com/search?q=site:facebook.com+crochetsa+south+africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Knit": [
    { label: "#knitSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23knitsa" },
    { label: "#mohairSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23mohairsa" },
    { label: "Knitting on Facebook", url: "https://www.google.com/search?q=site:facebook.com+knittersofsa+south+africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Stickers & Prints": [
    { label: "#stickersSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23stickerssa" },
    { label: "#sastationery on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23sastationery" },
    { label: "Stickers on Facebook", url: "https://www.google.com/search?q=site:facebook.com+stickers%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Plants": [
    { label: "#plantsofsa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23plantsofsa" },
    { label: "#capetownplants on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23capetownplants" },
    { label: "#proplifeza on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23proplifeza" },
    { label: "Plants on Facebook", url: "https://www.google.com/search?q=site:facebook.com+plantsofsouthafrica+south+africa" },
  ],
  "Candles": [
    { label: "#candlesSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23candlessa" },
    { label: "#soywaxsa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23soywaxsa" },
    { label: "Candles on Facebook", url: "https://www.google.com/search?q=site:facebook.com+candles%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Soap & Bath": [
    { label: "#handmadesoapsa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23handmadesoapsa" },
    { label: "#bathandbodysa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23bathandbodysa" },
    { label: "Soap on Facebook", url: "https://www.google.com/search?q=site:facebook.com+handmade%20soap%20south%20africa" },
    { label: "Faithful to Nature", url: "https://www.faithful-to-nature.co.za/search?keyword=handmade+soap" },
  ],
  "Beadwork & Jewelry": [
    { label: "#zulubeadwork on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23zulubeadwork" },
    { label: "#beadworkSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23beadworksa" },
    { label: "Beadwork on Facebook", url: "https://www.google.com/search?q=site:facebook.com+zulu%20beadwork" },
    { label: "African Mamas Crafts", url: "https://africanmamascrafts.co.za/" },
  ],
  "Woven & Basketry": [
    { label: "#zulubaskets on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23zulubaskets" },
    { label: "#telephonewireart on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23telephonewireart" },
    { label: "Baskets on Facebook", url: "https://www.google.com/search?q=site:facebook.com+south%20african%20baskets" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Ceramics": [
    { label: "#ceramicsSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23ceramicssa" },
    { label: "#sapottery on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23sapottery" },
    { label: "Ceramics on Facebook", url: "https://www.google.com/search?q=site:facebook.com+sapotters+south+africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Leather": [
    { label: "#leathersa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23leathersa" },
    { label: "#sahandmade on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23sahandmade" },
    { label: "Leather on Facebook", url: "https://www.google.com/search?q=site:facebook.com+leather%20craft%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Wood & Carving": [
    { label: "#woodworkSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23woodworksa" },
    { label: "#sawoodworking on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23sawoodworking" },
    { label: "Woodwork on Facebook", url: "https://www.google.com/search?q=site:facebook.com+woodworking%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Wirework": [
    { label: "#wireartSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23wireartsa" },
    { label: "#beadedwireart on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23beadedwireart" },
    { label: "Wire art on Facebook", url: "https://www.google.com/search?q=site:facebook.com+wire%20art%20south%20africa" },
    { label: "African Crafts Market", url: "https://www.africancraftsmarket.com" },
  ],
  "Tea & Herbal": [
    { label: "#rooibossa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23rooibossa" },
    { label: "#honeybushtea on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23honeybushtea" },
    { label: "Tea on Facebook", url: "https://www.google.com/search?q=site:facebook.com+rooibos%20tea" },
    { label: "Faithful to Nature — Tea", url: "https://www.faithful-to-nature.co.za/search?keyword=rooibos+tea" },
  ],
  "Coffee": [
    { label: "#sacoffee on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23sacoffee" },
    { label: "#capetowncoffee on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23capetowncoffee" },
    { label: "#specialitycoffeesa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23specialitycoffeesa" },
    { label: "Coffee on Facebook", url: "https://www.google.com/search?q=site:facebook.com+south%20africa%20coffee%20roasters" },
  ],
  "Stained Glass": [
    { label: "#stainedglasssa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23stainedglasssa" },
    { label: "#suncatchersa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23suncatchersa" },
    { label: "Stained Glass on Facebook", url: "https://www.google.com/search?q=site:facebook.com+stained%20glass%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Polymer Clay": [
    { label: "#polymerclaysa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23polymerclaysa" },
    { label: "#polymerclayearringssa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23polymerclayearringssa" },
    { label: "Polymer Clay on TikTok", url: "https://www.tiktok.com/search?q=polymer%20clay%20south%20africa" },
    { label: "Polymer Clay on Facebook", url: "https://www.google.com/search?q=site:facebook.com+polymer%20clay%20south%20africa" },
  ],
  "Resin Art": [
    { label: "#resinartsa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23resinartsa" },
    { label: "#sairesin on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23sairesin" },
    { label: "Resin Art on TikTok", url: "https://www.tiktok.com/search?q=resin%20art%20south%20africa" },
    { label: "Resin on Facebook", url: "https://www.google.com/search?q=site:facebook.com+resin%20art%20south%20africa" },
  ],
  "Embroidery": [
    { label: "#embroiderysa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23embroiderysa" },
    { label: "#hoopartSA on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23hoopartsa" },
    { label: "Embroidery on Facebook", url: "https://www.google.com/search?q=site:facebook.com+embroidery%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Macramé": [
    { label: "#macramesa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23macramesa" },
    { label: "#macramelovers on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23macramelovers" },
    { label: "Macramé on Facebook", url: "https://www.google.com/search?q=site:facebook.com+macrame%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Concrete Decor": [
    { label: "#concretesa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23concretesa" },
    { label: "#concreteplantersa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23concreteplantersa" },
    { label: "Concrete Decor on Facebook", url: "https://www.google.com/search?q=site:facebook.com+concrete%20decor%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
  "Pressed Flower": [
    { label: "#pressedflowersa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23pressedflowersa" },
    { label: "#botanicalartsa on IG", url: "https://www.instagram.com/explore/search/keyword/?q=%23botanicalartsa" },
    { label: "Pressed Flower on Facebook", url: "https://www.google.com/search?q=site:facebook.com+pressed%20flowers%20south%20africa" },
    { label: "Aya Africa", url: "https://aya.africa" },
  ],
};
